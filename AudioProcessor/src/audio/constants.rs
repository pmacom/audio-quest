...
pub struct Constants {
    ...
    pub amplitude_envelope_parameters: AmplitudeEnvelopeParameters,
    pub websocket_update_interval_ms: u64,
}

pub struct AmplitudeEnvelopeParameters {
    pub default_attack_rate: f32,
    pub default_decay_rate: f32,
    pub default_momentum_factor: f32,
    pub default_peak_hold_time: f32,
    pub adaptive_attack_multiplier: f32,
    pub adaptive_decay_multiplier: f32,
    pub transient_boost_factor: f32,
    pub transient_decay_rate: f32,
...
pub const CONSTANTS: Constants = Constants {
    ...
    amplitude_envelope_parameters: AmplitudeEnvelopeParameters {
        default_attack_rate: 0.15,
        default_decay_rate: 0.05,
        default_momentum_factor: 0.8,
        default_peak_hold_time: 0.1,
        adaptive_attack_multiplier: 0.2,
        adaptive_decay_multiplier: 0.3,
        transient_boost_factor: 0.3,
        transient_decay_rate: 0.92,
        silence_threshold: 0.05,
        peak_detection_threshold: 1.1,
    },
