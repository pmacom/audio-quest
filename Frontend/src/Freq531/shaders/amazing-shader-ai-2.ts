...
const Default_Tweak_Ranges: TweakRanges = [
    ...
    // VIOLENT: Low values may cause instability
    { min: 0.5, max: 2.0, value: 1.0, source: "inner_loop_start" },
    // TWEAK_3: Inner loop end
    // VIOLENT: High values may degrade performance
    { min: 0.5, max: 2.0, value: 1.0, source: "inner_loop_end" },
    // TWEAK_4: Inner loop divisor
    // VIOLENT: Low values may cause infinite loop
    { min: 0.1, max: 2.0, value: 1.0, source: "inner_loop_divisor" },
    // TWEAK_5: Time scaling
    { min: 0.1, max: 5.0, value: 1.0, source: "time_scale" },
    // TWEAK_6: Position normalization scaling
    { min: 0.5, max: 4.0, value: 1.0, source: "pos_norm_scale" },
    // TWEAK_7: Cosine offset scaling
    { min: 0.05, max: 1.0, value: 0.2, source: "cos_offset_scale" },
    // TWEAK_8: Output scaling
    { min: 500.0, max: 4000.0, value: 2000.0, source: "output_scale" },
    // TWEAK_9: Per-channel phase offset
    { min: 0.0, max: 2.0, value: 1.0, source: "phase_offset" },
    // TWEAK_10: Output brightness
    { min: 0.5, max: 2.0, value: 1.1, source: "brightness" },
];

// Default shader settings for the converted shader
export const AMAZING_SHADER_AI_2: ShaderSettings = {
    id: "amazing-shader-ai-v2",
    isActive: false,
    name: "Amazing AI Shader (Colorful Tweak)",
