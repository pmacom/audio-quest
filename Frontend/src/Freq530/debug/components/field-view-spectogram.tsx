...
export const FieldViewSpectogram = ({
  ...
  useEffect(() => {
    ...
    // Ensure we pass a true ArrayBuffer, not a SharedArrayBuffer
    const arrayBuffer = byteArray.buffer instanceof ArrayBuffer ? byteArray.buffer.slice(0) : new Uint8Array(byteArray).buffer;
