import { Freq530FieldTypes } from "./audio/store/useFreq530";
 ...
 */
// export function _getNormalizedTweakValue(
...
export const GetFieldType = (fieldKey: typeof Freq530FieldKeys[number]) => {
  return Freq530FieldTypes[fieldKey as keyof typeof Freq530FieldTypes];
}